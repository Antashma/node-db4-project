  ...
  return knex('recipe_ingredients').truncate()
    .then(function () {
      ...
      return knex('recipe_ingredients').insert([
        ...
        {recipe_id: 1, ingredient_id:2 , quantity: '1/4', measurement: 'tea'},
        {recipe_id: 1, ingredient_id:3 , quantity: '1', measurement: 'Tbl'},
        {recipe_id: 1, ingredient_id:4 , quantity: '3', measurement: 'Tbl'},
        {recipe_id: 1, ingredient_id:6 , quantity: '1/2', measurement: 'Tbl'},
